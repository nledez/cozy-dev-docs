...
Here you will find everything you need to understand Cozy technically and to develop konnectors and applications.

The **technical level required** to properly read and understand this documentation is not over 9,000: You will have to know how the Web works, from server-side to client-side, and to have notions in Node.js/JavaScript development.
...
Speaking of which, as you can see on your right (or above if you read this on a mobile device), code snippets are available in **both JavaScript and CoffeeScript** for <s>every troll's taste</s> everyone's preference.

By the way, do not hesitate to [edit this page](https://github.com/cozy-labs/cozy-dev-docs/tree/master/source/index.md) if you want to improve it.


## What is Cozy <small>and how we made it</small>
...
<a href="https://coffeescript.org" target="_blank"><img src="images/coffeescript.png" style="width: 30%"></a>
